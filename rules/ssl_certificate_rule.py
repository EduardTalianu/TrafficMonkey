    ...
    def analyze(self, db_cursor):
        ...
        try:
            ...
            if not db_cursor.fetchone():
                # Create the table for storing SSL certificate information
                db_cursor.execute("""
            ...
            tls_connections = db_cursor.fetchall()
            ...
            for src_ip, dst_ip, dst_port, connection_key in tls_connections:
                ...
                cert_info = db_cursor.fetchone()
                
                if cert_info:
                    subject, issuer, not_before, not_after, is_self_signed, signature_algorithm, subject_alt_names = cert_info
            ...
            return [f"Error in SSL Certificate rule: {str(e)}"]
